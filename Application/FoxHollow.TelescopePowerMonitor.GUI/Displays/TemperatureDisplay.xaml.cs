...
{
    /// <summary>
    /// Interaction logic for PercentageDisplay.xaml
    /// </summary>
    public partial class TemperatureDisplay : UserControl
    {
        public string Title
        {
        ...
        private void ValueChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                this.Current.Text = Formatting.FormatTemperature(this.Value.Current);
                this.Minimum.Text = Formatting.FormatTemperature(this.Value.Minimum);
                this.Maximum.Text = Formatting.FormatTemperature(this.Value.Maximum);
        ...
        private static void OnValuePropertyChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            if (e.Property.Name == nameof(Value))
                (e.NewValue as FloatValue).PropertyChanged += ((TemperatureDisplay)sender).ValueChanged;

            if (e.Property.Name == nameof(IsActive) && ((bool)e.NewValue) == false)
                ((TemperatureDisplay)sender).ResetView();
        }

        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(FloatValue), typeof(TemperatureDisplay), new UIPropertyMetadata(new FloatValue(), OnValuePropertyChanged));
        public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register("IsActive", typeof(bool), typeof(TemperatureDisplay), new UIPropertyMetadata(false, OnValuePropertyChanged));
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register("Title", typeof(string), typeof(TemperatureDisplay), new UIPropertyMetadata(" ", OnValuePropertyChanged));
    }
}
